...
@Singleton
@Startup
public class CVCNotificationProcess implements Serializable {

	private static final long serialVersionUID = 1223678612340966554L;

	private static final Logger logger = LoggerFactory.getLogger(CVCNotificationProcess.class);

	private static final String PREFIX_PROP_TIMER = "CVCNotificationProcess";
	...
	public void createTimer() {
		...
		if (timerService.getTimers().isEmpty()) {
			timerService.createCalendarTimer(scheduleExpression, new TimerConfig("CVCNotificationProcess", false));
