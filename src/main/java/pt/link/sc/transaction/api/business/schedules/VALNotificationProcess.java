...
@Singleton
@Startup
public class VALNotificationProcess implements Serializable {

	private static final long serialVersionUID = 1223678612340966554L;

	private static final Logger logger = LoggerFactory.getLogger(VALNotificationProcess.class);

	private static final String PREFIX_PROP_TIMER = "VALNotificationProcess";
	...
	public void createTimer() {
		...
		if (timerService.getTimers().isEmpty()) {
			timerService.createCalendarTimer(scheduleExpression, new TimerConfig("VALNotificationProcess", false));
