...
@Singleton
@Startup
public class CVCANotificationAcknowledgementProcess implements Serializable {

	private static final long serialVersionUID = 1223678612340966554L;

	private static final Logger logger = LoggerFactory.getLogger(CVCANotificationAcknowledgementProcess.class);

	private static final String PREFIX_PROP_TIMER = "CVCANotificationAcknowledgementProcess";
	...
	public void createTimer() {
		...
		if (timerService.getTimers().isEmpty()) {
			timerService.createCalendarTimer(scheduleExpression, new TimerConfig("CVCANotificationAcknowledgementProcess", false));
